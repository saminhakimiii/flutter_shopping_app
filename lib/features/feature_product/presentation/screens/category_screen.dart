...
import '../../../../commen/widgets/dot_loading_widget.dart';
import '../../../../locator.dart';
import '../../../feature_auth/data/models/login_with_sms_model.dart';
import '../../data/models/categories_model.dart';
import '../bloc/category_cubit/category_cubit.dart';
import 'all_products_screen.dart';
import 'package:flutter_shopping_app/features/feature_product/data/models/categories_model.dart' as ProductData;
                ...
                if(state.categoryDataStatus is CategoryDataCompleted){
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index){
                      ProductData.Data categoryData = categoriesModel.data![index];
                      /// text
